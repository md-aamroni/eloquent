...
use Adecoder\Eloquent\Resolver\UpdateResolver;
...
class Update implements FactoriesInterface, SqlQueryInterface
{
   /**
    * Database Connection
    * @var object
   ...
   public function get()
   {
      ...
      $parse = new UpdateResolver(query: $query);
      $maper = new FormatHandler(data: $parse->update($this->db)->response(), array: $this->array);
      return $maper->format();
   }
}
