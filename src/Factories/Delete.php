...
use Adecoder\Eloquent\Resolver\DeleteResolver;
...
class Delete implements FactoriesInterface, SqlQueryInterface
{
   /**
    * Database Connection
    * @var object
   ...
   public function get(): mixed
   {
      ...
      $parse = new DeleteResolver(query: $query);
      $maper = new FormatHandler(data: $parse->delete($this->db)->response(), array: $this->array);
      return $maper->format();
   }
}
